  ...
  if (!project) {
    return (
      <div className="text-center py-16">
        <h2 className="text-5xl font-bold text-blue-700">Project Not Found</h2>
        <Link href="/projects" className="mt-4 text-blue-700 font-medium hover:text-blue-800 inline-block">
          ← Back to Projects
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-6">
          <div className="mb-4">
            <span className="text-base font-semibold bg-blue-100 text-blue-700 px-2 py-1 rounded">
              {project.category}
            </span>
      ...
      <div className="mt-6">
        ...
        <div className="flex flex-wrap gap-2">
          {project.skills.map((skill, index) => (
            <span
              key={index}
              className="bg-blue-100 text-blue-700 text-base font-medium px-3 py-1 rounded"
            >
              {skill}
            </span>
          ))}
